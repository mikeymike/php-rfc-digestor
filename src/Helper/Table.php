...
namespace MikeyMike\RfcDigestor\Helper;
...
/**
 * C+P from \Symfony\Component\Console\Helper\Table
 * To allow to add \Symfony\Component\Console\Helper\TableStyle per row
 *
...
class Table
{
    ...
    public function addRow($row, TableStyle $style = null)
    {
    ...
    public function render()
    {
        ...
        foreach ($this->rows as $key => $row) {
            if ($row instanceof TableSeparator) {
                ...
                if (null !== $this->rowStyles[$key]) {
                    $this->renderRow($row, $this->rowStyles[$key]->getCellRowFormat());
                } else {
